...
func (_recv *S3Client) _CreateSession_Stub() {
	_recv._CreateSession_Do(func(context.Context, *s3.CreateSessionInput, ...func(*s3.Options)) (r0 *s3.CreateSessionOutput, r1 error) {
		return r0, r1
	})
}

func (_recv *S3Client) _CreateSession_Return(r0 *s3.CreateSessionOutput, r1 error) {
	_recv._CreateSession_Do(func(context.Context, *s3.CreateSessionInput, ...func(*s3.Options)) (*s3.CreateSessionOutput, error) {
		return r0, r1
	})
}
...
func (_recv *S3Client) _ListDirectoryBuckets_Stub() {
	_recv._ListDirectoryBuckets_Do(func(context.Context, *s3.ListDirectoryBucketsInput, ...func(*s3.Options)) (r0 *s3.ListDirectoryBucketsOutput, r1 error) {
		return r0, r1
	})
}

func (_recv *S3Client) _ListDirectoryBuckets_Return(r0 *s3.ListDirectoryBucketsOutput, r1 error) {
	_recv._ListDirectoryBuckets_Do(func(context.Context, *s3.ListDirectoryBucketsInput, ...func(*s3.Options)) (*s3.ListDirectoryBucketsOutput, error) {
		return r0, r1
	})
}
...
func (_recv *S3Client) _Options_Stub() {
	_recv._Options_Do(func() (r0 s3.Options) {
		return r0
	})
}

func (_recv *S3Client) _Options_Return(r0 s3.Options) {
	_recv._Options_Do(func() (s3.Options) {
		return r0
	})
}
